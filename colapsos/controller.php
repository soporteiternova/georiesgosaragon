...
class controller {
    ...
    protected function crondaemon($debug = false) {
        ...
        if ( $debug || $datetime === '0040' ) {
            ini_set( 'memory_limit', '4G' );
            $count = 0;
            $api_url = \georiesgosaragon\common\controller::get_endpoint_url( \georiesgosaragon\common\controller::ENDPOINT_COLAPSOS );
            ...
            echo '<br/><br/><br/><br/><br/>Updated ' . $count . ' collapses';
        }
